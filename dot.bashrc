...
alias npm="pnpm"
alias rm="safe-rm"
alias s="echo '---pwd---' && pwd && echo '---ls---' && ls --color=auto --group-directories-first && echo '---git log & status ---' && git log --decorate --oneline -n 5 2> /dev/null && git status -s 2> /dev/null"
